...
public class JobDetailFieldsTest extends BasicTest {
	 ...
	 * jobDetailPageCaseInfoSection() throws InterruptedException {
	 * 
	 * String futureDate = DateGenerator.getInstance().modifiedDate(0, 0, 1);
	 * 
	 * loginSteps.login(userStorage.getUser(0));
	 * globalSteps.clickCreateJobIcon(); globalSteps.openWidgetIn(1);
	 * 
	 * jobDetailSteps.setDate(futureDate);
	 * jobDetailSteps.setCaseName("Sony presentation"); //TODO: Mark Case name
	 * as TBD jobDetailSteps.selectCaseType("Meeting");
	 * jobDetailSteps.assertJobDetailHeaderLabel(JobDetailHeaderLabel.JOB_TYPE,
	 * "Meeting");
	 * 
	 ...
	 * 
	 * @Screenshots(onlyOnFailures = true) public void
	 * jobDetailPageWitnessInfoSection() throws InterruptedException {
	 * 
	 * loginSteps.login(userStorage.getUser(0));
	 * globalSteps.clickCreateJobIcon(); globalSteps.openWidgetIn(1);
	 * 
	 ...
	 * 
	 * @Screenshots(onlyOnFailures = true) public void
	 * jobDetailPageLocationInfoSection() throws InterruptedException {
	 * 
	 * Address address1 = new Address();
	 * address1.setCompany("Century City Bar Association")
	 * .setAddress("1616 Ocean Park Boulevard") .setCity("Santa Monica")
	 * .setZip("90405") .setCountry("United States of America");
	 * 
	 ...
	 * 
	 * jobDetailSteps.checkLocationAddress(1, address2); //BUG: 'Clear address'
	 * link doesn't work }
	 * 
	 * @Test
	 * 
	 ...
	 * 
	 * @Screenshots(onlyOnFailures = true) public void
	 * jobDetailPageClientInfoSection() throws InterruptedException {
	 * 
	 * loginSteps.login(userStorage.getUser(0));
	 * globalSteps.clickCreateJobIcon(); globalSteps.openWidgetIn(1);
	 * 
	 ...
	 * 
	 * @Screenshots(onlyOnFailures = true) public void
	 * jobDetailPageClientMatter() throws InterruptedException {
	 * 
	 * String futureDate = DateGenerator.getInstance().modifiedDate(0, 0, 1);
	 * 
	 * loginSteps.login(userStorage.getUser(0));
