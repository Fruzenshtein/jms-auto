...
public class JobDetailFieldsTest extends BasicTest {
	...
	public void tc_5_4_1() throws InterruptedException {
		...
		globalSteps.pause(5);
		jobDetailSteps
				.addAndAssertSchedulingFirmIsAdded("Ann Van Devanter Townsend");
	...
	public void tc_5_5_1_1() {
		...
		jobDetailSteps.isServiceIconInVendorSection(VendorService.VIDEOGRAPHER,
				true);
		jobDetailSteps.isServiceIconInWitnessInfo(VendorService.VIDEOGRAPHER,
				true);
		jobDetailSteps.isServiceIconInVendorSection(VendorService.STREAMING,
				true);
		jobDetailSteps
				.isServiceIconInWitnessInfo(VendorService.STREAMING, true);
		jobDetailSteps.isServiceIconInVendorSection(VendorService.INTERPRETER,
				true);
		jobDetailSteps.isServiceIconInWitnessInfo(VendorService.INTERPRETER,
				true);
		...
		jobDetailSteps.assertJobDetailHeaderLabel(
				JobDetailHeaderLabel.REPORTERS,
				"Internet Real-Time, Regular (8-Day) Delivery");
	}

	@Test
	@Screenshots(onlyOnFailures = true)
	public void tc_5_5_1_2() {

		loginSteps.login(userStorage.getUser(0));
		globalSteps.searchJobById("2201");
		// Videographer tab
		globalSteps.pause(3);
		jobDetailSteps.selectVendorTab(VendorTab.VIDEOGRAPHER.getTab(),
				VendorTab.VIDEOGRAPHER.getVendor());
		jobDetailSteps.setExpectedStartTime("11:00 AM");
		jobDetailSteps.assertExpectedStartTime("11:00 AM");
		jobDetailSteps.setExpectedFinishTime("06:00 PM");
		jobDetailSteps.assertExpectedFinishTime("06:00 PM");
		...
		jobDetailSteps.assertJobDetailHeaderLabel(
				JobDetailHeaderLabel.STREAMING, "Internet Real-Time");
	}
	...
	public void tc_5_5_1_3() {
		...
		jobDetailSteps
				.assertJobDetailHeaderLabel(
						...
						"Andrew Rosner & Associates (600 Old Country Road, Suite 520, Garden City, NY, US), Video Conference");

	}

	@Test
	@Screenshots(onlyOnFailures = true)
	public void tc_5_6_1_1() throws AWTException {
	...
	//	jobDetailSteps.assertCommissionPercentage(1, "4");
		...
		jobDetailSteps.deleteAppliedCommission(2);
		jobDetailSteps.clearNotesCommissionSection();
		jobDetailSteps.addCommissionNotes("Commission notes");
		jobDetailSteps.addSalesPerson();
		jobDetailSteps.selectSalesPerson(4);
		jobDetailSteps.applySalesPerson();
		jobDetailSteps.changeCommissionPercentage(1, "75");
		jobDetailSteps.clickSave();
		globalSteps.pause(8);
	...
	@Test
	@Screenshots(onlyOnFailures = true)
	public void tc_5_6_1_3() throws AWTException {
